...
[role="lead"]
Para otimizar o desempenho do seu ASA r2, pode ser necessário modificar suas unidades de storage para aumentar a capacidade, atualizar as políticas de QoS ou alterar os hosts mapeados para as unidades. Por exemplo, se uma nova carga de trabalho de aplicativo crítica for adicionada a uma unidade de storage existente, talvez seja necessário alterar a política de Quality of Service (QoS) aplicada à unidade de storage para suportar o nível de desempenho necessário para o novo aplicativo.

.Aumentar a capacidade
Aumente o tamanho de uma unidade de storage antes que ela atinja sua capacidade máxima para evitar a perda de acesso aos dados que pode ocorrer se a unidade de storage ficar sem espaço gravável. A capacidade de uma unidade de storage pode ser aumentada para 128 TB, que é o tamanho máximo permitido pelo ONTAP.

...
[role="lead"]
A partir do ONTAP 9.18.1, você pode migrar uma máquina virtual de storage (VM) de qualquer cluster ASA padrão para qualquer cluster ASA r2 sem interrupções. Migrar de um cluster ASA padrão para um cluster ASA r2 permite que você adote a arquitetura simplificada e otimizada dos sistemas ASA r2 para ambientes somente SAN.

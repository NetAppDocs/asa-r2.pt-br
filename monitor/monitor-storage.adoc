...
.O que se segue?
Se a sua zona de disponibilidade de storage estiver com pouco espaço, você deve planejar link:../manage-data/move-storage-units.html["mova as unidades de armazenamento"] para outra zona de disponibilidade de storage para equilibrar a utilização do storage em todo o cluster, excluir snapshots para liberar espaço ou adicionar discos adicionais aos seus nós para aumentar a capacidade.

...
[role="lead"]
Utilize o ONTAP System Manager para visualizar uma lista de erros ou alertas, ações corretivas recomendadas, registros de auditoria do sistema e trabalhos ativos, concluídos ou com falha.
...
.Resultado
O endereço de e-mail que você adicionou recebe as notificações por e-mail especificadas para eventos do cluster e registros de auditoria.

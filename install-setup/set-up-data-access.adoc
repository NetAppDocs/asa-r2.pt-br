...
* Saiba mais sobrelink:https://kb.netapp.com/on-prem/ontap/da/SAN/SAN-KBs/How_to_setup_Broadcom_VMware_ESXi_iSCSI_MPIO_with_ONTAP_SAN_ASA["Como configurar o Broadcom VMware ESXi iSCSI MPIO com sistemas de armazenamento ONTAP SAN ASA"^] .
...
A partir do ONTAP 9.19.1, o FLI oferece suporte ao protocolo iSCSI para conectividade de backend.

* Saiba mais sobre o link: https://docs.netapp.com/us-en/ontap-fli/get-started/learn-about-data-migration.html[ONTAP FLI migrations^].

...
summary: Conecte o sistema de storage ASA A70 ou ASA A90 à sua rede e aos seus shelves de storage para habilitar a comunicação em cluster, acesso de gerenciamento e conectividade de host SAN. 
---
= Conecte o hardware para os sistemas de storage ASA A70 e ASA A90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* Os slots de E/S nos modelos ASA A70 e ASA A90 são numerados de 1 a 11.
+
image::../media/drw_a1K_back_slots_labeled_ieops-2162.svg[Numeração de slots em um controlador ASA A70 e ASA A90]
...
+
image::../media/drw_70-90_network_cabling1_ieops-1654.svg[Cabo para rede Ethernet de 100 GbE]
...
image::../media/oie_cable_sfp_gbe_copper.svg[Cabo 10/25 GbE]

image::../media/drw_70-90_network_cabling2_ieops-1655.svg[Cabo para rede Ethernet 10/25 GbE]
...
Os sistemas de storage ASA A70 e ASA A90 suportam gabinetes NS224 com o módulo NSM100 ou NSM100B. As principais diferenças entre os módulos são:
...
.. Conecte a porta e8a à porta e0a do NSM A da shelf 2.
.. Conecte a porta e8b à porta e0b do shelf 1 NSM B.
+
...
.. Conecte a porta e8a à porta e0a do shelf 2 NSM B.
.. Conecte a porta e8b à porta e0b do NSM A do shelf 1.
+

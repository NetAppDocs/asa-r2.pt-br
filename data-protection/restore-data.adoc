...
Restaurar um grupo de consistência substitui os dados em todas as unidades de storage do grupo de consistência pelos dados de um snapshot. Alterações feitas nas unidades de storage após a criação do snapshot não são restauradas.

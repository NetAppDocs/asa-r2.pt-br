...
[role="lead"]
Você pode usar o System Manager para renomear um nó no seu sistema ASA r2 para alinhá-lo às convenções de nomenclatura da sua organização ou por outros motivos administrativos.

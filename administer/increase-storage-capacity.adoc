...
O número mínimo de unidades que você deve adicionar em um único procedimento é três. Adicionar uma unidade única pode reduzir o desempenho.
...
+
** Se o LED estiver aceso continuamente, a unidade está recebendo energia.

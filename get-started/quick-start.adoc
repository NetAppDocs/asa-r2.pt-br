...
[role="lead"]
Para colocar seu sistema ASA r2 em funcionamento, você instala os componentes de hardware, configura o cluster, configura o acesso aos dados dos seus clientes SAN ao sistema de storage e provisiona seu storage.

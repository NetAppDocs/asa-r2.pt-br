...
| Sistemas  a| 
Os seguintes sistemas NetApp ASA r2 são suportados a partir do ONTAP 9.16.1. Esses sistemas oferecem uma solução unificada de hardware e software que cria uma experiência simplificada, específica para as necessidades de clientes que utilizam apenas SAN.
...
| link:../learn-more/additional-supported-ontap-features.html#san-protocols["Alocação de espaço NVMe habilitada por padrão"]  a| 

...
summary: Aprimore a segurança dos seus dados configurando o NVMe TCP sobre TLS para criptografar todos os dados enviados pela rede entre o seu host NVMe TCP e ONTAP. 
---
...
. Selecione image:icon_add_blue_bg.png["Quadrado azul com um sinal de mais seguido da palavra Adicionar em letras brancas"].
